    ...
    try {
      ...
      try {
        ...
        if (latLngs.isNotEmpty) {
          AppLogger.debug(
            'First point: ${latLngs.first.latitude}, ${latLngs.first.longitude}',
          );
          AppLogger.debug(
            'Last point: ${latLngs.last.latitude}, ${latLngs.last.longitude}',
          );
        }
      } catch (e) {
      ...
      AppLogger.debug(
        'Lng range: ${lngRange.reduce((a, b) => a < b ? a : b)} to ${lngRange.reduce((a, b) => a > b ? a : b)}',
      );
